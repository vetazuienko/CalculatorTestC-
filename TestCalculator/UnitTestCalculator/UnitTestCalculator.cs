...
namespace UnitTestCalculator
{
    ...
    public class UnitTestCalculator
    {
        ...
        public void TestSumWithDelta()
        {
            ...
            Assert.AreEqual(expected_result, result, delta, "{0} + {1} = {2} expected and {3} was calculated", a, b, expected_result, result);
        ...
        public void TestSub()
        {
            ...
            double result = calc.calculate(first_number, second_number, Calculator.operation_types.sub);

            // result of test = assert

            //Assert.Equals(expected_result, real_result);

            Assert.AreEqual(expected_result, result, "Subdivision first number on second");
        ...
        public void TestMult()
        {
            ...
            double result = calc.calculate(first_number, second_number, Calculator.operation_types.mult);

            // result of test = assert

            //Assert.Equals(expected_result, real_result);

            Assert.AreEqual(expected_result, result, "Multiplty first number on second");
        }
    }
